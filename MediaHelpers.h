...
using ICreateAdaptiveMediaSourceOperation = ABI::Windows::Foundation::IAsyncOperation<
    ABI::Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceCreationResult*>;
using ICreateAdaptiveMediaSourceResultHandler = ABI::Windows::Foundation::IAsyncOperationCompletedHandler<
    ABI::Windows::Media::Streaming::Adaptive::AdaptiveMediaSourceCreationResult*>;
using ICreateAudioGraphOperation = ABI::Windows::Foundation::IAsyncOperation<
    ABI::Windows::Media::Audio::CreateAudioGraphResult*>;
using ICreateMediaSourceAudioInputNodeOperation = ABI::Windows::Foundation::IAsyncOperation<
    ABI::Windows::Media::Audio::CreateMediaSourceAudioInputNodeResult*>;
using ICreateAudioFileInputNodeOperation = ABI::Windows::Foundation::IAsyncOperation<
    ABI::Windows::Media::Audio::CreateAudioFileInputNodeResult*>;
using IOpenFileOperation = ABI::Windows::Foundation::IAsyncOperation<
    ABI::Windows::Storage::Streams::IRandomAccessStream*>;
using IOpenStorageFileOperation = ABI::Windows::Foundation::IAsyncOperation<
...
HRESULT CreateInputNode(_In_ ABI::Windows::Media::Audio::IAudioGraph* pAudioGraph,
    _In_ LPCWSTR path,
    _COM_Outptr_ ABI::Windows::Media::Audio::IAudioFileInputNode** pp,
    _Outptr_opt_ ABI::Windows::Media::Audio::ICreateAudioFileInputNodeResult** ppResult
);

HRESULT CreateOutputNode(_In_ ABI::Windows::Media::Audio::IAudioGraph* pAudioGraph,
    _COM_Outptr_ ABI::Windows::Media::Audio::IAudioFrameOutputNode** pp);
