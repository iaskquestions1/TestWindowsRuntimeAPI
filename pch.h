...
static HRESULT AddStringProperty(ABI::Windows::Foundation::Collections::IMap<HSTRING, IInspectable*>* pIMap, PCWSTR key,
                                 PCWSTR value)
{
    ...
    IFR(Windows::Foundation::GetActivationFactory(Microsoft::WRL::Wrappers::HStringReference(
        RuntimeClass_Windows_Foundation_PropertyValue).Get(), &spGenericActivationFactoryInterface));
...
static HRESULT AddBooleanProperty(ABI::Windows::Foundation::Collections::IMap<HSTRING, IInspectable*>* pIMap,
                                  PCWSTR key, bool value)
{
    Microsoft::WRL::ComPtr<IActivationFactory> spGenericActivationFactoryInterface;
    Microsoft::WRL::ComPtr<ABI::Windows::Foundation::IPropertyValueStatics> pFactory;
...
static HRESULT AddInt64Property(ABI::Windows::Foundation::Collections::IMap<HSTRING, IInspectable*>* pIMap, PCWSTR key,
                                __int64 value)
{
    Microsoft::WRL::ComPtr<IActivationFactory> spGenericActivationFactoryInterface;
    Microsoft::WRL::ComPtr<ABI::Windows::Foundation::IPropertyValueStatics> pFactory;
